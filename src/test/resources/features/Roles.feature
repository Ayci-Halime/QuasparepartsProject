...
@PositiveScenario
  ...
  Scenario: TC_0019_0001
    ...
    And Der Benutzer sieht, dass der Accountant angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Accountant geklickt hat.
    And Benutzer meldet sich ab


  Scenario: TC_0019_0002
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Logistics Manager angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Logistics Manager geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0003
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Purchase Manager angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Purchase Manager geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0004
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Sales Manager angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Sales Manager geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0005
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Warehouse Manager angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf  Warehouse Manager geklickt hat.
    And Benutzer meldet sich ab


  Scenario: TC_0019_0006
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Business Owner angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Business Owner geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0007
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Logistics Personnel angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Logistics Personnel  geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0008
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Quality Controller angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Quality Controll geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0009
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Sales Personnel angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Sales Personnel geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0010
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Warehouse Personnel angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Warehouse Personnel geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0011
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Customer angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Customer geklickt hat.
    And Benutzer meldet sich ab

  Scenario: TC_0019_0012
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Purchase Manager angekommen ist.
  ...
  Scenario: TC_0019_0013
    Given Benutzer klickt links auf der Seite auf Rolles.
    And Der Benutzer sieht, dass der Quality Manager angekommen ist.
    Then Der Benutzer bestaetigt, dass er auf Quality Manager geklickt hat.
    And Benutzer meldet sich ab


  Scenario: TC_0019_0014
    Given Benutzer klickt links auf der Seite auf Rolles.
